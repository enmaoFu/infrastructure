...
<div class="easyui-radio" id="radio">
    <input type="radio" name="question" value="oui" checked  label="oui">
    <input type="radio" name="question" value="oui1"  label="oui1">
    <input type="radio" name="question" value="oui2"  label="oui2">
</div>
*/
(function ($) {
    var STYLE = {
