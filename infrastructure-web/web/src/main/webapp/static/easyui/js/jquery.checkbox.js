...
<span class="easyui-checkbox" id="checkbox">
    <input type="checkbox" name="question" value="oui1" checked label="oui">
    <input type="checkbox" name="question2" value="oui2" checked label="oui1">
    <input type="checkbox" name="question2" value="oui3" checked label="oui2">
</span>
*/
(function ($) {
