...
.img404 {
	PADDING-RIGHT: 0px;
	PADDING-LEFT: 0px;
	BACKGROUND: url(http://www.codefans.net/jscss/demoimg/201105/404dat.gif)
		no-repeat left top;
	FLOAT: left;
	PADDING-BOTTOM: 0px;
	MARGIN: 0px;
...
<body>
	<h1 class="hidehr">当前页不存在，或你输入的网址不正确，我们会原谅您的手下之误！</h1>
	<div class="img404"></div>
	<h2>抱歉，找不到您要的页面……</h2>
	<h3 class="wearesorry">we're sorry but the page your are looking for
		is not found...</h3>
	<div class="content">
		...
		<strong>点击以下链接继续浏览其它内容</strong>（<a href="http://www.baidu.com/" target="_blank">http://www.baidu.com/</a>）：
		<div class="show14">
			<ul>
					<li><a title="返回上一页" href="javascript:history.back(-1)">返回上一页</a></li>
			</ul>
		</div>
		要不，我们去<a href="http://www.sina.com.cn/" target="blank">新浪</a>看看吧……
	</div>
